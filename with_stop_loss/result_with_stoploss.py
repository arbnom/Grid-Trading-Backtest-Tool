...
def create_price_sequence(data, grid_values):
    ...
    for index, row in data.iterrows():
        ...
        # Stop sequence generation if price goes outside of the grid range
...
def calculate_end_position_price(sequence, grid_values, initial_price):
    waiting_point_index = grid_values.index(min(grid_values, key=lambda x: abs(x - initial_price)))
...
final_ETH_price_in_USDC = calculate_end_position_price(price_sequence, grid_values, initial_price)
